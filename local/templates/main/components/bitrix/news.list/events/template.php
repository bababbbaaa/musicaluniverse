        ...
        <div class="col">
            ...
            <div class="row">
                <?foreach($arResult["ITEMS"] as $arItem):?>
                    ...
                    <div class="news-list-item calendar-item mb-4 col-3" id="<?=$this->GetEditAreaId($arItem['ID']);?>" data-date="<?=$arItem["ACTIVE_FROM"]?>">
                        <div class="card">
                            ...
                            ?>
                            <span class="event_type"><img src="<?=SITE_TEMPLATE_PATH . "/images/" . $type . ".svg"?>" alt=""></span>
